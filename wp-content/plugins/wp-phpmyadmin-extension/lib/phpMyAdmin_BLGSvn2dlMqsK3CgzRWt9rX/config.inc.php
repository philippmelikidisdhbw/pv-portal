...
$i++;
$cfg['Servers'][$i]['host'] 			= 'db5016923583.hosting-data.io';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'Rc((&;\"vj~D\":jC7;QK]Md6E-N7@CJsb' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_BLGSvn2dlMqsK3CgzRWt9rX/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://solarsolutionsgmbh.com/wp-admin/?rand=34036662&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://solarsolutionsgmbh.com/wp-admin/?rand=31326907&pma_logout=1';
